...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["update"])) {
        ...
        if ($valid) {
            ...
            $statement = $connect->query("SELECT * FROM utilisateurs WHERE id = $id");
            $i = $statement->fetch();
            $_SESSION["client"] = [
              "id" => $i["id"],
              "nom" => $i["nom"],
  ...
  <ul class="list-unstyled">
    ...
    <li class="dropdown pc-h-item header-user-profile">
      <a
        ...
        aria-expanded="false"
      >
        <img src="../../assets/images/user/<?= $user["avatar"] ?>" alt="user-image" class="user-avtar">
        <span><?= $user["nom"] ?></span>
      </a>
        ...
        <div class="dropdown-header">
          <div class="d-flex mb-1">
            <div class="flex-shrink-0">
              <img src="../../assets/images/user/<?= $user["avatar"] ?>" alt="user-image" class="user-avtar wid-35">
            </div>
            <div class="flex-grow-1 ms-3">
              <h6 class="mb-1"><?= $user["nom"] ?></h6>
    ...
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div id="edit-card-container">
                <div id="edit-card">
                    <div id="edit-image">
                        <img src="../../assets/images/user/<?= $user["avatar"] ?>" alt="profile">
                    </div>
                    <form action="" method="post">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Enter your name" value="<?= $user["nom"] ?>">
